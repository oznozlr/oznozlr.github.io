        ...
        openGraph: {
          ...
          alternates: {
            ...
            languages: {
              ...
              'tr-TR': `${process.env.NEXT_PUBLIC_SITE_URL}/tr/${category}`,
            },
          },
    }
};
...
*/
    ...
    const typeCurrectedCategory = category as unknown as {
        id: string;
        title: string;
        description: string;
        slug: string;
  ...
  return (
    <PaddingContainer>
        <div className='mb-10'>
            <h1 className='text-4xl font-semibold'>{ typeCurrectedCategory?.title}</h1>
            <p className='text-lg text-neutral-600'>{ typeCurrectedCategory?.description}</p>
        </div>
        <PostList locale={locale} posts={typeCurrectedCategory.posts} />
    </PaddingContainer>
